...
const Conversation = (props: ConvoProps) => {
  ...
  const { setReceiverID } = useConversation();
    ...
    <button onClick={handleClick}>
      <div className="flex gap-2 items-center hover:bg-sky-500 rounded-lg p-2 py-1 cursor-pointer group text-left">
        ...
        <div className="flex flex-col flex-1">
          <p className="text-gray-200 group-hover:text-white">{loading ? <span className="loading loading-dots loading-xs"></span> : username}</p>
